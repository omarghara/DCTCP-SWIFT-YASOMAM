...
#define INIT_MIN 2000
#define INIT_MAX 60000
...
class TcpSocketState : public Object
{
  public:
    ...
    //////////////////////////SWIFT MODIFICATION///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //modSwift//
    //these parameters are swift's per flow parameters.
    Time m_t_last_decrease; //last time we decreased the cwnd
    ...
    bool CanDecrease(){
       ...
       Time timeSinceLastDecrease = Simulator::Now() - m_t_last_decrease;

        // Return whether enough time has passed
       return timeSinceLastDecrease >= m_lastRtt.Get();


    } // permission to decrease cwnd


    void Clamp () {
        if(m_cWnd < m_min_cwnd)
        {
            m_cWnd = m_min_cwnd;
        }
        else if(m_cWnd > m_max_cwnd)
        { 
            m_cWnd = m_max_cwnd;
        }
    }
